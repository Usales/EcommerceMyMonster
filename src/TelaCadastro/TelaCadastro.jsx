    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="container mx-auto px-4 pt-[210px] pb-16">
        <div className="max-w-md mx-auto slide-down-fade">
          ...
          >
            <h1 className="text-2xl sm:text-3xl font-bold text-center mb-6 text-white/90">Cadastro</h1>
            
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="codinome" className="block text-sm sm:text-base font-medium text-white/80 mb-2">
                  Codinome
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="confirmarSenha" className="block text-sm sm:text-base font-medium text-white/80 mb-2">
                  Confirmar Senha
                </label>
                <input
                  type="password"
            ...
            <div className="mt-6 text-center">
              <p className="text-sm sm:text-base text-white/60">
                Já tem uma conta?{' '}
                <Link to="/login" className="text-white hover:text-white/80 border-b border-white">
                  Faça login
                </Link>
              </p>
            </div>
